...
class TestSummarizeText:
    ...
    def test_calls_ollama_with_correct_model(self, mocker):
        ...
        mock_client.chat.return_value = {"message": {"content": "# Test Summary"}}
        mocker.patch("audio_summary.cli.ollama.Client", return_value=mock_client)
...
class TestResearchText:
    ...
    def test_calls_ollama_with_correct_model(self, mocker):
        ...
        mock_client = mocker.MagicMock()
        mock_client.chat.return_value = {"message": {"content": "# Research Analysis"}}
        mocker.patch("audio_summary.cli.ollama.Client", return_value=mock_client)
